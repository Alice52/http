...
1. 简介
   ...
   - restful 是一种对基于 http 的满足一定`规范与约束`的应用设计风格(统一接口)
     ...
     2. 尽可能复用 http 特性来规范软件设计{甚至提高传输效率}
...
6. cons & pros
   ...
   - pros: 清晰可读, 简单, 易用, 高效, **无状态**
   - cons: 资源不明确 | 多资源 | 返回不同 Vo | 动作向 | api 数量(请求数量) | 维护管理 | 版本兼容
...
1. [rest](https://github.com/Alice52/http/issues/7)
   - http://restful.p2hp.com/
   - [凤凰架构-rest 风格](https://icyfenix.cn/architect-perspective/general-architecture/api-style/rest.html)
1. https://zhuanlan.zhihu.com/p/54976216
1. [rest-api design](https://www.cnblogs.com/duanweishi/p/9539219.html)
1. [rest best practice github](https://docs.github.com/en/rest/repos/repos)
